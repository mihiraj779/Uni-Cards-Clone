...
"
      ...
      <section className="py-12 bg-background-gradient lg:py-[100px] bg-cover gradient-color download-bg">
        <div className="w-full max-w-7xl mx-auto px-6 md:px-4  md:flex md:justify-around items-center my-4">
          ...
          <img
              className="md:h-[50px] h-[40px] w-[140px] md:w-auto"
              src="https://www.uni.cards/images/nx-wave/play_store_logo.svg"
              alt="play-store"
            />
            <img
              className="md:h-[50px] h-[40px] w-[140px] md:w-auto"
              src="https://www.uni.cards/images/nx-wave/app_store_logo.svg"
              alt="app-store"
            />
        </div>
      </section>
      <footer className="bg-[#1C2132] text-white py-10">
        <div className="max-w-7xl mx-auto px-8 md:px-4">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <div className="flex flex-col">
              <address className="not-italic mb-6 md:mb-0">
                Indiqube Sigma No.3/B, Nexus Koramangala 3rd Block SBI Colony, Koramangala, Bengaluru, Karnataka 560034<br />
                Contact Us: 080 68216821<br />
                Email: <a href="mailto:care@uni.club" className="hover:underline">care@uni.club</a>
              </address>
              <a href="#" className="hover:underline mb-6">Delete Account</a>
            </div>
            <div className="flex flex-col md:flex-row md:gap-4">
              ...
              <a href="#" className="hover:underline">
                Grievance Redressal Mechanism - Yes Bank India
              </a>
            </div>
          </div>
          <div className="flex flex-col md:flex-row md:justify-between md:items-center mt-6">
            ...
            <div className="flex flex-col md:flex-row md:gap-4 text-xs text-gray-400">
              <a href="#" className="hover:underline">Credit Card KFS</a>
              <a href="#" className="hover:underline">Credit Card MITCs</a>
              <a href="#" className="hover:underline">Uni T&Cs</a>
              <a href="#" className="hover:underline">Lending Partner TnCs</a>
            </div>
          </div>
